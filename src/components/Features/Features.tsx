      ...
      <FeatureBlock>
        <FeatureBlock.TextContent>
          ...
          <FeatureBlock.Description>
            The unique approach to client management our team at FitNet came up
            with enables coaches to save time on doing routine tasks and grow
            their client network all inside one app!
          </FeatureBlock.Description>
        </FeatureBlock.TextContent>
      ...
      <FeatureBlock>
        <FeatureBlock.TextContent>
          ...
          <FeatureBlock.Description>
            ...
            exactly what FitNet was designed for - the all-in-one tool where you
            can do all you might need, from scaling your business to managing
            statistics. That&apos;s how we empower coaches and drive value.
          </FeatureBlock.Description>
        </FeatureBlock.TextContent>
        ...
        <FeatureBlock.FeatureList>
          ...
          <Feature>
            ...
            <Feature.TextContent>
              ...
              <Feature.Description>
                Use our interactive calendar to track who, when and for how long
                is gonna use your services.
              </Feature.Description>
            </Feature.TextContent>
          </Feature>
